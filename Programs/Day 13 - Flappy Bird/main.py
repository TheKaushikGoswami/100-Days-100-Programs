...
bird_up = pygame.image.load(r"Programs\Day 13 - Flappy Bird\assets\img_47.png")
bird_down = pygame.image.load(r"Programs\Day 13 - Flappy Bird\assets\img_48.png")
bird_mid = pygame.image.load(r"Programs\Day 13 - Flappy Bird\assets\img_49.png")
...
# Loading pipe image
pipe_img = pygame.image.load(r"Programs\Day 13 - Flappy Bird\assets\greenpipe.png")
...
game_over = False
over_img = pygame.image.load(r"Programs\Day 13 - Flappy Bird\assets\img_45.png").convert_alpha()
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN or event.type == pygame.MOUSEBUTTONDOWN:
            if event.type == pygame.KEYDOWN and event.key == pygame.K_SPACE:
                if not game_over:  # If space key is pressed
                    bird_movement = 0
                    bird_movement = -7
                else:  # If space key is pressed after game over
                    game_over = False
                    pipes = []
                    bird_movement = 0
                    bird_rect = bird_img.get_rect(center=(67, 622 // 2))
            ...
            if event.type == pygame.MOUSEBUTTONDOWN and event.button == 1:
                if not game_over:  # If primary mouse button is clicked
                    bird_movement = 0
                    bird_movement = -7
                else:  # If primary mouse button is clicked after game over
                    game_over = False
                    pipes = []
                    bird_movement = 0
                    bird_rect = bird_img.get_rect(center=(67, 622 // 2))
